...
//* Lab. Computación Gráfica e Interacción Humano-Computadora  *
...
// Camera
Camera  camera(glm::vec3(0.0f, 8.0f, 45.0f));  //Definimos la posición de la cámara
...
//Variables para animación de los relojes
...
int main()
{
	...
	//******* Modelo de Doc para animación por huesos ********
...
//KeyCallback sirve más para activar las variables booleanas de las animaciones
